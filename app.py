...
이때 '철자 그대로'가 아니라, 실제 원어민이 말하는 소리에 최대한 가깝게 한글로 옮기세요(강세 음절, 약하게 흘리는 모음, 연음, 받침소리까지 반영).
예: "Schedule (스케쥴)", "Comfortable (컴퍼터블)", "Vegetable (베지터블)", "Develop (디벨럽)", "Quote (쿠욷)", "Water (워럴)", "Prospective (프러스펙팁)".

{length_rule}

[★ 데이터 추출 마커 — 반드시 맨 마지막 줄. 발음은 원어민 소리에 가까운 한글 음차 ★]
|||EXTRACT|||
NEW_PATTERN: 패턴구조 | 뜻
